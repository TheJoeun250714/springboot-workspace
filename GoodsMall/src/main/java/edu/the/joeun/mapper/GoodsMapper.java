...
* 각 회사 개발자들이 작성한 SQL  을 기반으로 움직일 명칭들을 작성
*
* mapper.xml 파일에서
* id 로 작성한 명칭과 class Mapper.java 에서 작성하는 기능 명칭이
...
public interface GoodsMapper {
    ...
    */
    List<Goods> getAll(); // 모든 상품들 조회 = List<객체 타입 문서명칭 설정>
    /*
    ...
    */
    ...
    // int - return : 총 몇 개의 상품이 저장되었는지 SQL 에서 반환
}
