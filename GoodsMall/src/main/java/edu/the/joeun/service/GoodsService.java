...
public class GoodsService {
     ...
     * 모든 상품 정보를 조회
     *
     * @return SQL 에서 가져온 상품 목록(List<Goods>)을 반환하여
     ...
     *
     * @param = 파라미터 = 매개변수로 Controller에서 전달받은 데이터를 담고 있는 변수 명칭들 설정
     *
