...
public class 페이지이동이외모든작업Controller {
    ...
    /*
      ...
      RestController 어노테이션에는 이 기능이 존재해서 굳ㅇ ㅣ추가로 작성하지 않아도 됨

      Controller 에서 부분적으로 JSON형태 변환이 필요할 경우 사용

      ==================================================================
      RequestBody
      클라이언트가 보낸 JSON 형태의 데이터를 JAVA 형태로 변환
      POST, PUT 요청을 DB로 저장, 수정할 때 주로 사용
    *
    * */

    // js 에서 데이터 등록하는 fetch promise axios ajax 와 동일한
    // 주소를 가져야 한다.
